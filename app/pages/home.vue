...
<template>
  ...
  <div class="bg-teal-700 py-3">
    <Carousel v-bind="carouselConfig">
      <Slide v-for="slide in slides" :key="slide.id">
        <img :src="slide.src" :alt="slide.alt" class="w-full h-48 object-cover" />
      </Slide>
        ...
        <div class="p-2">
          ...
          <div class="space-y-2">
            ...
            <div class="flex items-start text-gray-600 text-[10px]">
              <svg class="w-3 h-3 mr-2 ml-0.5 mt-0.5 text-teal-600 flex-shrink-0" fill="none" stroke="currentColor"
                viewBox="0 0 24 24">
  ...
  <!-- Volunteer Sign Up -->
  <div
    class="bg-gradient-to-br from-rose-700 to-rose-800 text-center py-3 px-4 relative overflow-hidden items-center justify-center min-h-[100px]">
    ...
    <button @click="handleSignUp"
      ...
      <span
        class="absolute inset-0 z-0 opacity-0 scale-95 rounded-full group-hover:opacity-100 group-hover:scale-100 transition-transform duration-300 bg-rose-50"></span>
  ...
  <div class="px-2 pb-4 pt-4">
    ...
    <div class="flex gap-3 overflow-x-auto pb-2 scrollbar-hide">
      <a v-for="service in services" :key="service.id" :href="service.href" target="_blank" rel="noopener noreferrer"
