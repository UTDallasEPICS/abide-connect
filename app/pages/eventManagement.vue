...
const upcomingEvents = ref([
  { 
    ...
    date: "2025-12-20",
    image: "https://images.unsplash.com/photo-1519167758481-83f29da8c1b0?w=400"
  },
  { 
    id: 5, 
    name: "Spring Concert",
        ...
        <div class="flex gap-3 overflow-x-auto pb-2">
          ...
          >
            <div 
              ...
              :style="event.image ? `background-image: url(${event.image}); background-size: cover; background-position: center;` : ''"
            >
              <span v-if="!event.image">+</span>
            </div>
            <div class="h-[40px] bg-gray-200 rounded-b-2xl flex items-center justify-center px-2">
              <p class="text-xs font-medium text-gray-700 truncate">{{ event.name }}</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="px-5 mt-6">
        ...
        <div class="mt-4 flex flex-col gap-4">
          ...
          >
            ...
            <div class="flex flex-col">
              <p class="text-gray-800 font-semibold">{{ event.name }}</p>
